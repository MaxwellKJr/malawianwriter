...
const Showcase = () => {
  return (
      <section
        ...
        <div
            className="w-full px-5 pb-20 pt-40 sm:pt-24 md:px-0 md:w-3/ lg:w-1/2 4 h-full flex flex-col lg:flex-row justify-center items-center mx-auto max-w-screen-lg">
