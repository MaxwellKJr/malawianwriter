...
const Header = () => {
  return (
    <nav className='bg-white p-4 fixed top-0 w-full sm:border-b-[1px]'>
      <div className='flex flex-col sm:flex-row w-full sm:w-10/12 m-auto justify-center sm:justify-stretch items-center'>
        <Link href={`/`} className='text-2xl font-Poppins font-light text-black hover:text-brand w-full text-center sm:text-left pb-4 sm:pb-0'>
