...
const PostPage = (props: any) => {
	...
	return (
		<PageWrapper>
			<title>{`${story.data.title} | Malawian Writer 🇲🇼`}</title>
			<meta property='description' content={`${story.data.description}`} />
			<meta property='og:title' content={`${story.data.title} | Malawian Writer 🇲🇼`} />
			...
			<meta name='twitter:title' content={`${story.data.title} | Malawian Writer 🇲🇼 `} />
